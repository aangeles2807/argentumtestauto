...
public class QueryTemplate {
	...
	"	AND sysdate BETWEEN mpr.mprperini \n" +
	"	AND mpr.mprperfin \n" +
	...
	"	AND sysdate BETWEEN con.confechaleg \n" +
	...
	"	AND sysdate BETWEEN cvn.cvnperini \n" +
	"	AND cvn.cvnperfin \n" +
	"	AND cvn.tipmodcod = '1' \n" +
	"	JOIN tabconmcv mcv \n" +
	"	ON 1 = 1 \n" +
	...
	"		cvn.cvnmod \n" +
	"	END \n" +
	"	AND sysdate BETWEEN mcv.mcvperini \n" +
	"	AND mcv.mcvperfin \n" +
	...
	"	AND sysdate BETWEEN tar.pre_tar_periodoini \n" +
