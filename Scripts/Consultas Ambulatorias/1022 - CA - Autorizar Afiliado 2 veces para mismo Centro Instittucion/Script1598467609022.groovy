...
mapaVariablesScript = WS.callTestCase(findTestCase('Comun/ProcesoAutorizacion'), [
	...
	'servicioConsulta' : Keyword.SERVICIO_CONSULTA_AMBULATORIA.value.replace(" AND trim(ips.tipinscod) = '18'", "") + Keyword.PRESTADOR_CENTRO_INSTITUCION.value], FailureHandling.STOP_ON_FAILURE);
