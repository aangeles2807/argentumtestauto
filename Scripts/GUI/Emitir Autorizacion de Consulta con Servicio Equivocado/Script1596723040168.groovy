...
String datosDelAfiliado = "1784373";
String servicio = "ESTUDIOS ESPECIALIZADOS";
	...
	if (guiApoloComonAction.waitLoadingLogoNotShowing()) {
		...
		if (guiApoloComonAction.waitLoadingLogoNotShowing()) {
			...
			if (guiApoloComonAction.waitLoadingLogoNotShowing()) {
				...
				if (commonAction.verifyTestObjectExistence(Keyword.CSS_SELECTOR.value, ".warning-modal", commonAction.getTimeout1Second(), commonAction.getTimeout5Seconds(), false, true) != null) {
					
					message = String.valueOf("<b>No existe información en el modelo.<br>El Procedimiento no tiene asociado el servicio.<b><br>");
					...
					commonAction.clickToWebElement(Keyword.CSS_SELECTOR.value, ".warning-modal button.btn-primary", "Cerrar", false, false, false);
