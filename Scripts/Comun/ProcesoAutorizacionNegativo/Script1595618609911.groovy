...
try {
	...
	println Keyword.AFILIADO_MPP.value;
	...
	if (responseObject.getStatusCode().equals(200)) {
		...
		KeywordUtil.markFailed(String.valueOf("El API dio codigo de estado 200"));
		 
	}else{
	
		KeywordUtil.markPassed(String.valueOf("El API dio codigo de estado ${responseObject.getStatusCode()}"));
	}
